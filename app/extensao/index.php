...
$projects = research_projects_data('extensao');
...
page_header($selected ? (string)$selected['title'] : 'Extensao');
?>
<div class="container py-4">
    <?php if ($selected): ?>
        ...
        ?>
        <a class="btn btn-outline-secondary btn-sm mb-3" href="/extensao/index.php">Voltar para extensao</a>
        <div class="card shadow-sm">
            <div id="extensaoCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-indicators">
                    <?php foreach ($gallery as $idx => $photo): ?>
                        <button type="button" data-bs-target="#extensaoCarousel" data-bs-slide-to="<?= e((string)$idx) ?>" class="<?= $idx === 0 ? 'active' : '' ?>" <?= $idx === 0 ? 'aria-current="true"' : '' ?> aria-label="Foto <?= e((string)($idx + 1)) ?>"></button>
                    <?php endforeach; ?>
                </div>
                ...
                <?php if (count($gallery) > 1): ?>
                    <button class="carousel-control-prev" type="button" data-bs-target="#extensaoCarousel" data-bs-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="visually-hidden">Anterior</span></button>
                    <button class="carousel-control-next" type="button" data-bs-target="#extensaoCarousel" data-bs-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="visually-hidden">Proxima</span></button>
                <?php endif; ?>
            </div>
            <div class="card-body">
                <span class="badge text-bg-secondary mb-2">Extensao</span>
    ...
    <?php else: ?>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card news-card card-clickable h-100 shadow-sm position-relative">
                        ...
                        <div class="card-body d-flex flex-column">
                            <a class="stretched-link" href="/extensao/index.php?slug=<?= e((string)$project['slug']) ?>"><span class="visually-hidden">Abrir projeto <?= e((string)$project['title']) ?></span></a>
                            <span class="badge text-bg-secondary mb-2">Extensao</span>
                            ...
                            <div class="mt-auto d-flex flex-wrap gap-2 position-relative" style="z-index:2;">
                                <a class="btn btn-outline-primary btn-sm" href="/extensao/index.php?slug=<?= e((string)$project['slug']) ?>">Ver detalhes</a>
        ...
        <?php if (empty($projects)): ?><div class="alert alert-warning mt-4 mb-0">Nenhum item de extensao cadastrado.</div><?php endif; ?>
    <?php endif; ?>
</div>
<?php page_footer(); ?>
